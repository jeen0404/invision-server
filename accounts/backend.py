...
class PhoneBackend(ModelBackend):
    ...
    def authenticate(self, request, token_id=None, otp=None, **extra_fields):
        if token_id is None:
            return

        # 1. Validating the PhoneToken with token_id and OTP.
        ...
        try:
            ...
            phone_token = PhoneToken.objects.get(token_id=token_id)
